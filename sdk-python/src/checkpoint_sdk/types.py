"""
Dataclass response models for the Checkpoint SDK.

All fields map 1-to-1 with the JSON keys returned by the Checkpoint Service
API (snake_case). Optional fields default to None / empty collection.
"""
...
@dataclass
class Agent:
    """An agent registered with the checkpoint service."""
